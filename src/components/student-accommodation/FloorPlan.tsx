...
import floorPlanImage from '@/assets/student-accommodation/Student_Accommodation_FloorPlan.png';

function FloorPlanMesh() {
    const texture = useLoader(THREE.TextureLoader, floorPlanImage);
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-muted-foreground">
                        Explore the Student Accommodation in 3D
                    </p>
                </div>
