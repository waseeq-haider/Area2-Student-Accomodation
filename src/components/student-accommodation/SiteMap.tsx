...
export const SiteMap = () => {
    const [selectedArea, setSelectedArea] = useState<Area | null>(areas[1]); // Area 2 default (index 1)
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Explore how Area 2 connects to all other zones at Musafir Retreats & Camps
                    </p>
                </div>
                                                ...
                                                area.connections.map(connId => {
                                                    ...
                                                    return (
                                                        <path
                                                            ...
                                                            stroke={isHighlighted ? area.color : "hsl(var(--muted-foreground))"}
                                                            strokeWidth={isHighlighted ? "0.5" : "0.3"}
                                                            fill="none"
                                                            strokeDasharray={area.id === 2 || connId === 2 ? "2,2" : "none"}
